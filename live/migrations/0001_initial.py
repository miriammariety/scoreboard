...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rank', models.SmallIntegerField(choices=[(0, 'None'), (1, 'First'), (2, 'Second'), (3, 'Third'), (4, 'Fourth')], default=0, help_text='The rank for this cluster-event pair.')),
        ...
        migrations.AlterUniqueTogether(
            name='rank',
            unique_together=set([('cluster', 'event')]),
        ),
    ]
